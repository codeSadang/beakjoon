...
public class 황병수 {
    ...
    static ArrayList<Integer>[] adj; // 그래프를 인접 리스트로 표현
    ...
    public static void main(String[] args) {
        ...
        int m = sc.nextInt(); // 직접 연결된 쌍의 수

        adj = new ArrayList[n + 1]; // 1번부터 n번 컴퓨터까지 사용 (0번 인덱스는 사용하지 않음)
